...
export function registerCompanyTools(server: Server) {
    ...
    try {
      ...
      switch (request.params.name) {
        ...
        case 'search_companies': {
          ...
          if (args.min_market_cap) query = query.gte('market_cap', args.min_market_cap);

          if (args.max_market_cap) query = query.lte('market_cap', args.max_market_cap);
