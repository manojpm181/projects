        ...
        try {
            switch (request.params.name) {
                case 'get_analyst_ratings': {
                    const { ticker, firm, limit = 10 } = request.params.arguments;
                    // Get company ID
                        ...
                        content: [{
                                ...
                                text: JSON.stringify({
                                    ...
                                    analysis: {
                                        ...
                                        average_target_price: targetCount > 0 ? totalTarget / targetCount : null,
...
//# sourceMappingURL=analystTools.js.map