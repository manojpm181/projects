...
export function registerFinancialTools(server) {
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        try {
            switch (request.params.name) {
                case 'get_financial_report': {
                    const { ticker, fiscal_year, fiscal_quarter } = request.params.arguments;
                    // Get company ID
                ...
                case 'compare_companies': {
                    const { tickers } = request.params.arguments;
                    ...
                    const comparisons = await Promise.all(companies.map(async (company) => {
...
//# sourceMappingURL=financialTools.js.map